...
+ - [x] The default GraphQL limits set in the query methods are not working, set it up accordingly
+ - [x] Model field change, IMG filenames should be generated by the DB
