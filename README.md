...
+ - [x] Move image files in the image-cdn service to lfs
+ - [ ] Model field change, IMG filenames should be generated by the DB
+ - [ ] The order of the Hottest Episodes section should be defined by the amount of views each episode has
...
+ - [ ] Take into account that with the new changes, you need to prevent Movies/Specials from appearing in the hottest episodes and newest episodes sections
